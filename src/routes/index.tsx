...
export const Route = createFileRoute("/")({
  head: () => {
    ...
    const DESC =
      "Practise UK mock tests online with instant results. Prepare for Driving Theory, Life in the UK, English, CSCS, NHS, SIA and professional exams across 139 test topics, 13,770 mock tests and 330,480 practice questions.";
  ...
  return (
    <div className="text-center">
      <div className="inline-flex items-center justify-center gap-4 md:gap-6">
        <span aria-hidden className="hidden h-px w-12 bg-gradient-to-r from-transparent to-coral/60 sm:block md:w-20" />
        <h2 className="font-display text-2xl font-extrabold uppercase tracking-[0.22em] text-navy-deep md:text-3xl lg:text-4xl">
          {children}
        </h2>
        <span aria-hidden className="hidden h-px w-12 bg-gradient-to-l from-transparent to-coral/60 sm:block md:w-20" />
      </div>
      <div className="mx-auto mt-4 flex items-center justify-center gap-1.5">
        <span className="h-1 w-1 rounded-full bg-coral/60" />
        <span className="h-[3px] w-14 rounded-full bg-coral" />
        <span className="h-1 w-1 rounded-full bg-coral/60" />
      </div>
    </div>
  );
        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 px-4 pb-16 pt-10 md:px-6 md:pb-24 md:pt-14 lg:grid-cols-[1fr_280px] lg:items-center">
          <div>
            ...
            <p className="mt-6 max-w-xl text-base leading-relaxed text-navy-foreground/90 md:text-lg">
              ...
              Life in the UK, English, CSCS, NHS, SIA and professional exams. Study anytime, anywhere across 139 Test Topics.&nbsp;Mock paper totals include topic, skill and level combinations across all categories.
            </p>
            ...
            <div className="mt-5 flex flex-wrap items-center gap-2">
              ...
              <span className="inline-flex items-center gap-1.5 rounded-full border border-[#e8c07a]/40 bg-[#e8c07a]/10 px-3 py-1 text-xs font-semibold tracking-wide text-[#e8c07a]">
                <span className="font-bold whitespace-nowrap text-center">13,770 Mock Tests</span>
              </span>
              <span className="inline-flex items-center gap-1.5 rounded-full border border-[#e8c07a]/40 bg-[#e8c07a]/10 px-3 py-1 text-xs font-semibold tracking-wide text-[#e8c07a]">
                    ...
                    <div className="relative flex items-start gap-3">
                      {c.icon === "Car" || c.icon === "Crown" || c.icon === "Languages" || c.icon === "GraduationCap" || c.icon === "School" || c.icon === "University" || c.icon === "Taxi" || c.icon === "Briefcase" || c.icon === "ShieldCheck" || c.icon === "HeartPulse" || c.icon === "ChefHat" || c.icon === "HardHat" || c.icon === "HardHatSafety" || c.icon === "Calculator" || c.icon === "Cpu" || c.icon === "Cloud" || c.icon === "Shield" || c.icon === "Plane" || c.icon === "Stethoscope" || c.icon === "BookOpen" || c.icon === "Scale" || c.icon === "Siren" || c.icon === "Landmark" || c.icon === "Truck" || c.icon === "HandHeart" || c.icon === "Scissors" || c.icon === "ShoppingBag" || c.icon === "PawPrint" || c.icon === "Sparkles" ? (
                        <CategoryIcon
                          name={c.icon}
                          alt={c.title}
                          className="h-16 w-16 shrink-0 object-contain drop-shadow-[0_6px_12px_rgba(0,0,0,0.45)] transition-transform duration-300 group-hover:animate-jump-once"
                        />
                      ) : (
                        <span className={`flex h-16 w-16 shrink-0 items-center justify-center bg-gradient-to-br ${th.iconGrad} text-white shadow-[0_6px_16px_-6px_rgba(0,0,0,0.55)] ring-1 ring-white/20 transition-transform duration-300 group-hover:animate-jump-once`}>
                          <CategoryIcon
                            name={c.icon}
                            alt={c.title}
