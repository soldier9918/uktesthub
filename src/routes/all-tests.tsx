  ...
  head: () => ({
    meta: [
      { title: "All UK Mock Tests | UK Test Hub" },
      {
        name: "description",
        content:
          "Browse 139 UK test topics, 13,770 mock papers and 330,480 practice questions across Driving, Citizenship, English, Taxi & Private Hire, NHS, Construction, Security and more.",
      },
      {
        property: "og:title",
      ...
      <section className="bg-navy-deep text-navy-foreground">
        <div className="mx-auto max-w-7xl px-4 py-12 md:px-6 md:py-16">
          ...
          <p className="mt-4 max-w-3xl text-base text-navy-foreground/80 md:text-lg">
            ...
            test topics, 13,770 mock papers and 330,480 mock practice questions across Driving,
            Citizenship, English, Taxi &amp; Private Hire, NHS, Construction,
            Security and more. Pick a test to start instantly.
          </p>
        </div>
      </section>
