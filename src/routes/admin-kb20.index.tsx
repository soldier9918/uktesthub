      ...
      <main className="mx-auto max-w-5xl px-4 py-8">
        ...
        <div className="mt-2 grid gap-3 sm:grid-cols-2">
          ...
          <Tile to="/admin-kb20/mock-intros-import" title="Mock Intros CSV Import"
            desc="Upload CSV of per-mock difficulty, 'What this mock covers' and 'Common mistakes' for any topic. Commits to per-mock-intros.ts on GitHub. Includes rollback." />
