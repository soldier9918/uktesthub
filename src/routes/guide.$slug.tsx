          ...
          {topic.slug === "bmat" && (
            <div className="mt-6 max-w-3xl rounded-2xl border border-coral/40 bg-coral/10 p-5 text-sm leading-relaxed text-navy-foreground/90 backdrop-blur">
              ...
              <p className="mt-2">
                ...
                admissions tests, mainly UCAT. This guide is kept for historical
                reference only.
              </p>
              <p className="mt-3 flex flex-wrap gap-3">
                ...
                >
                  Read the UCAT guide <ArrowRight className="h-3.5 w-3.5" />
                </Link>
                <Link
                  to="/topic/$slug"
                  params={{ slug: "ucat" }}
          ...
          {(topic.slug === "qts-numeracy" || topic.slug === "qts-literacy") && (
            <div className="mt-6 max-w-3xl rounded-2xl border border-coral/40 bg-coral/10 p-5 text-sm leading-relaxed text-navy-foreground/90 backdrop-blur">
              ...
              <p className="mt-2">
                ...
                part of ITT recruitment. This guide is retained for historical reference
                only.
              </p>
            </div>
          )}
