...
const staticUrls = [
  ...
  ["/seru-test-practice", "weekly", "0.9"],
  ["/topographical-test-london", "weekly", "0.9"],
  ["/sia-door-supervisor-mock-test", "weekly", "0.9"],
  ["/cscs-mock-test-free", "weekly", "0.9"],
  ["/driving-theory-test-questions", "weekly", "0.9"],
  ["/life-in-the-uk-test-practice", "weekly", "0.9"],
  ["/uk-road-signs-test", "weekly", "0.9"],
  ["/nhs-numeracy-test-practice", "weekly", "0.9"],
  ["/about", "monthly", "0.6"],
  ["/contact", "monthly", "0.6"],
  ["/faq", "monthly", "0.6"],
  ["/privacy", "yearly", "0.3"],
