...
export const MOCK_INTROS: Record<string, MockIntro> = {
  "driving-theory": {
    description:
      "This Driving Theory mock test helps you practise the full breadth of the DVSA car theory syllabus — road signs, hazard awareness, safety margins, motorway rules, vulnerable road users, alertness, attitude and vehicle handling. The questions follow the same multiple-choice format used in the real test, with one correct answer per question and clear, plain-English explanations. Use it to find out which topics you have nailed and which still need work before you book your real exam at a DVSA test centre. Sit it in Practice mode for instant explanations after each question, or in Exam mode for a timed 24-question dry run that mirrors the real test-day pressure. After finishing, review every explanation carefully — especially the questions you answered incorrectly — and come back to the topic-by-topic mini-quizzes if you want focused revision before retrying the full mock.",
    topics: [
  ...
  "cscs-operative": {
    description:
      "This CSCS Operative mock test simulates the CITB Health, Safety & Environment Test required for the green Labourer / Operative CSCS card. It uses the same 50-question, multiple-choice format and the same balance of topics as the real assessment: general responsibilities, health and welfare, working environment, plant and equipment, and high-risk activities. Use Practice mode to learn as you go, with an explanation after each question, or Exam mode for a fully timed run-through that mirrors what you'll sit at a Pearson VUE centre. Aim for a clear margin above the pass mark before booking your real test — a comfortable practice score is the best predictor of a first-time pass.",
    topics: [
  ...
  seru: {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Around 90 minutes at a TfL-approved test centre.",
      },
      {
  ...
  topographical: {
    description:
      "This Topographical mock test helps you prepare for the Topographical Skills Assessment that all new London private hire drivers must pass. The questions cover the same areas as the live test at a TfL-approved centre — reading an A–Z style London street map, identifying postcode districts, planning sensible routes that avoid restricted roads, recognising major landmarks and using a compass. Use Practice mode to learn each question type as you go, with explanations after every question, or Exam mode for a timed run that mirrors the pressure of the real assessment. Pair these mocks with hands-on time using a paper London A–Z — that's the single biggest predictor of a first-time pass.",
    topics: [
...
export function getMockIntro(topicSlug: string, topicTitle: string): MockIntro {
  ...
  return {
    description: `This ${topicTitle} mock test gives you a realistic, multiple-choice practice sitting in the same format as the real assessment. It draws from across the syllabus so you can spot which areas you're strong in and which still need more work before test day. Use Practice mode for instant feedback and explanations after every question, or Exam mode for a timed dry run that mirrors real test-day pressure. After finishing, review every explanation carefully — especially the questions you answered incorrectly — and come back to retake the mock until you're consistently scoring well above the pass mark. UK Test Hub is independent and not affiliated with any awarding body; these are practice-style questions designed to reflect the format and difficulty of the real exam.`,
    topics: [
