...
const EXAM_CONFIGS: Record<string, ExamConfig> = {
  ...
  seru: {
    ...
    passMarkPct: 75,
    passScore: 18,
    title: "SERU Practice Exam",
    description:
      "SERU-style timed practice — multiple-choice and missing-word questions. Practice target: 75%.",
    heading: "SERU Exam Mode",
    intro: [
      "Practise with a SERU-style timed test for London private hire drivers, drawn from the TfL Private Hire Driver's Handbook.",
      "You will answer a mix of multiple-choice and missing-word / sentence-completion questions under timed conditions. We set a practice target of 75% so you can track progress — TfL does not publish a fixed percentage pass mark.",
      "Covers passenger safety, safeguarding, equality, disability awareness, driver responsibilities, licensing rules and professional conduct.",
    ],
    buttonLabel: "Start SERU Practice Exam",
    passLabel: "75% practice target",
    timeLabel: "SERU-style timed practice",
  },
